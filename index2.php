...
<html lang="en">
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-dark justify-content-between">
        <a class="navbar-brand" href="#">Kandy Buy <i class='fas fa-desktop'></i></a>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption">
              ...
              <p><a href="product2.php">SHOP NOW!</a></p>
            </div>
          </div>
...
<div class="jumbotron">
  <div class="container-fluid text-center">
    ...
    <a href="product2.php"><p>SHOP NOW!</p></a>
  </div>
</div>
  ...
  <div class="site-slider-two px-md-4">
    <div class="row slider-two text-center">
      ...
      <div class="product-top">
        ...
        <div class="overlay">
          <a href="product2.php"><button type="button" class="btn btn-secondary" title="Quick Shop"><i class="fa fa-eye"></i></button></a>
